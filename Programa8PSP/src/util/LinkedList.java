...
public class LinkedList extends List{
	...
	@Override
	public void addNode(double firstData, double secondData , double thirdData , double fourData) {
		if (isEmpty()) this.firstNode = lastNode = new Node(firstData,secondData , thirdData , fourData);
        
        else {
        	this.firstNode = new Node(firstData,secondData, thirdData , fourData , this.firstNode);
        }
	}
